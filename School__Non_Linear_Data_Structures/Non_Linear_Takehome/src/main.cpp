...
void handleProcessing(string inputStringsArray[], Heap *&myHeap)
{
...
void handleOutput(Heap *&myHeap)
{
	...
	{
		out << myHeap->heap[i]->toString() << endl;
	}
...
int main()
{
	...
	handleProcessing(inputStringsArray, myHeap);
	handleOutput(myHeap);
